package com.github.fenrir.xdataflowtrace.configs;
...
public class URISelectorConfig implements Serializable {
    ...
    public String match(String serviceName, String interfaceURI){
        ...
        for(String target : interfaceList){
            if(this._match(interfaceURI, target)){
                return target;
            }
        }
        return interfaceURI;
