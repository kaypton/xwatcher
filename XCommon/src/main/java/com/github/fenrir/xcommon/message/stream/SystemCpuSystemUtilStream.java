...
// percentage
@Stream(name = "system.cpu.system.util", topicName = "stream.system.cpu.system.util",
        description = "cpu system util")
public class SystemCpuSystemUtilStream extends BaseStream {
