...
@RestController
@RequestMapping(path = "/api/v1/persistence")
public class PersistenceProcessorController {
    private final ProcessorService service;

    public PersistenceProcessorController(@Autowired ProcessorService service){
